        ...
        >
          <div className="box-border caret-transparent">
            ...
            <div className="box-border caret-transparent mb-12 md:mb-16">
              ...
              <p className="text-gray-200 text-base sm:text-lg md:text-xl box-border caret-transparent leading-7 mb-6">
                Expert shed installation services in Greater Glasgow providing professional installation of custom sheds for storage and garden use. Our shed installation process ensures that your new shed is properly positioned, secured, and finished to the highest standards. We handle everything from site preparation to final installation, ensuring your shed is ready for immediate use. <a href="/service/sheds" className="text-[#787e59] hover:underline font-medium">Get started with shed installation</a>.
              </p>
            </div>
            ...
            <div className="box-border caret-transparent mb-12 md:mb-16">
              ...
              <p className="text-gray-200 text-base sm:text-lg md:text-xl box-border caret-transparent leading-7 mb-6 md:mb-8">
                As experienced contractors in Greater Glasgow, we provide comprehensive construction and installation services including deck construction, patio construction, fencing, decking, gates, sheds, and garden rooms. Our professional contractors serve residential and commercial clients throughout Greater Glasgow and Glasgow with over 13 years of experience. <a href="/contractor-irvine" className="text-[#787e59] hover:underline font-medium">Learn more about our contractor services in Greater Glasgow</a>.
              </p>
              ...
              <p className="text-gray-200 text-base sm:text-lg md:text-xl box-border caret-transparent leading-7 mb-6">
                Professional deck construction services in Greater Glasgow and Glasgow. We build decks from scratch, planning everything properly so it lasts. Deck construction in Greater Glasgow means using materials that can handle our weather. <a href="/service/deck-construction-irvine" className="text-[#787e59] hover:underline font-medium">Learn more about deck construction</a>.
              </p>
            ...
            <div className="box-border caret-transparent mb-12 md:mb-16">
              ...
              <p className="text-gray-200 text-base sm:text-lg md:text-xl box-border caret-transparent leading-7 mb-6 md:mb-8">
                Landscape design helps tie everything together. We design outdoor spaces that work well and look good. From planning where things go to actually building them, we handle the whole process. Our landscape designers in Greater Glasgow understand how to create outdoor spaces that enhance your property's value. <a href="/landscape-designer-irvine" className="text-[#787e59] hover:underline font-medium">Explore our landscape design services</a>.
              </p>
              ...
              <p className="text-gray-200 text-base sm:text-lg md:text-xl box-border caret-transparent leading-7 mb-6">
                Professional outdoor step construction in Greater Glasgow. We build steps that are safe, durable, and complement your outdoor space design. <a href="/service/outdoor-step-construction-irvine" className="text-[#787e59] hover:underline font-medium">Discover outdoor step construction</a>.
              </p>
            ...
            <div className="box-border caret-transparent mb-12 md:mb-16">
              ...
              <p className="text-gray-200 text-base sm:text-lg md:text-xl box-border caret-transparent leading-7 mb-6 md:mb-8">
                As a construction company, we handle repairs and maintenance for all the work we do. Once we've built something, we're here to help keep it in good shape. Our construction company in Greater Glasgow provides comprehensive building and installation services for outdoor structures. <a href="/construction-company-irvine" className="text-[#787e59] hover:underline font-medium">Find out more about our construction services</a>.
              </p>
            ...
            <div className="box-border caret-transparent mb-12 md:mb-16">
              ...
              <p className="text-gray-200 text-base sm:text-lg md:text-xl box-border caret-transparent leading-7 mb-6 md:mb-8">
                Professional garage building services in Greater Glasgow and Glasgow. We design and construct custom garages tailored to your specific requirements. Our experienced garage builders work with you to create practical, secure storage solutions that enhance your property's functionality. <a href="/garage-builder-irvine" className="text-[#787e59] hover:underline font-medium">Learn more about our garage building services</a>.
              </p>
            </div>
