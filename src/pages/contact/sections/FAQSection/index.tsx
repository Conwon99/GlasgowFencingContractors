...
const faqData = [
  {
    question: "What factors influence the price of a fencing or decking project?",
    answer: "Several factors affect pricing, including the size of the area, the type of materials used, the complexity of the installation, ground preparation requirements, and any additional services or features required. We provide free quotes that detail all costs with no hidden fees."
  },
  {
