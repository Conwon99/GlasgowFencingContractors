...
export const FAQItem = (props: FAQItemProps) => {
  ...
  return (
    <article className="items-stretch box-border caret-transparent flex flex-col justify-center" itemScope itemType="https://schema.org/Question">
      ...
      >
        <h3 className="text-gray-900 text-xl font-bold box-border caret-transparent leading-[26px] md:text-[22px] md:leading-[28.6px]" itemProp="name">
          {props.question}
        </h3>
      ...
      >
        <p className="text-gray-900 text-sm box-border caret-transparent leading-[22.4px] max-w-full pt-5 md:text-lg md:leading-[27px] md:max-w-none" itemProp="text">
          {props.answer}
        </p>
      </div>
