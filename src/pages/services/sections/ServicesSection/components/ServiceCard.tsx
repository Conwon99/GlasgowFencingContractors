    ...
    >
      <div className="box-border caret-transparent">
        <div className="relative box-border caret-transparent mb-[30px]">
          <img
            src={props.iconUrl}
            alt={`${props.title} service icon`}
            className="box-border caret-transparent inline-block h-10 max-w-full w-10"
          />
        </div>
        <div className="box-border caret-transparent">
          <h3 className="text-white text-[22px] font-bold box-border caret-transparent leading-[26.4px] mb-2.5 md:text-[26px] md:leading-[31.2px]">
            {props.title}
          </h3>
          <p className="text-gray-200 box-border caret-transparent my-[30px] md:my-[50px]">
            {props.description}
          </p>
        </div>
      </div>
