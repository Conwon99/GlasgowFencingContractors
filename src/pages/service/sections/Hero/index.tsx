import { HeroContent } from "@/pages/service/sections/Hero/components/HeroContent";
...
export const Hero = ({ slug }: HeroProps) => {
  return (
    <section className="box-border caret-transparent pt-[100px] md:pt-[120px]">
      <div className="relative bg-gray-900 box-border caret-transparent mx-[15px] pt-[100px] pb-[120px] rounded-[20px] md:pt-[180px] md:pb-[230px]">
