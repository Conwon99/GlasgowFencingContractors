...
export const projects: Project[] = [
  // Fencing Projects
  {
    ...
    imageAlt: "Venetian Fencing & Gate installation in the Greater Glasgow area",
    seoTitle: "Venetian Fencing & Gate Installation Greater Glasgow | Glasgow Fencing Contractors",
    seoDescription: "View our completed Venetian fencing and gate installation in the Greater Glasgow area. Professional installation showcasing quality craftsmanship and durable fencing solutions.",
    challenge: "The client required a stylish and modern fencing solution that would provide privacy while maintaining an attractive appearance. Venetian fencing was chosen for its contemporary look and ability to offer both security and visual appeal. The project needed to integrate seamlessly with the existing property layout and accommodate a matching gate for vehicle access.",
  ...
  },
  {
    ...
    imageAlt: "Concrete posts and composite panels with gate installation in the Greater Glasgow area",
    seoTitle: "Concrete Posts & Composite Panels Gate Installation Greater Glasgow | Glasgow Fencing Contractors",
    seoDescription: "Explore our concrete posts and composite panels fencing installation with gate in the Greater Glasgow area. Expert craftsmanship delivering secure, attractive boundary solutions.",
    challenge: "This property required a robust, long-lasting fencing solution that could withstand the Scottish weather conditions while providing maximum security and privacy. The client wanted a low-maintenance option that would look great for many years without requiring regular painting or treatment. The installation needed to include a secure gate for vehicle access.",
  ...
  },
  {
    ...
    imageAlt: "Timber overlap fencing with coping and double gates in the Greater Glasgow area",
    seoTitle: "Timber Overlap Fencing with Coping & Double Gates Greater Glasgow | Glasgow Fencing Contractors",
    seoDescription: "See our timber overlap fencing with coping and double gates completed in the Greater Glasgow area. High-quality timber fencing installation demonstrating professional workmanship.",
  ...
  },
  {
    ...
    imageAlt: "47m of composite fencing with 2 bespoke gates featuring dark grey slats, black composite and aluminium posts, black trellis, trims and caps in Greater Glasgow",
    seoTitle: "Composite Fencing & Bespoke Gates Installation Greater Glasgow | Glasgow Fencing Contractors",
    seoDescription: "View our completed 47m composite fencing installation with 2 bespoke gates in Greater Glasgow. Dark grey slats with black composite and aluminium posts, black trellis, trims and caps. Professional installation completed to the highest standard.",
  ...
  // Decking Projects
  {
    ...
    imageAlt: "Timber wheelchair access and steps installation in West Central Scotland",
    seoTitle: "Timber Wheelchair Access & Steps Installation West Central Scotland | Glasgow Fencing Contractors",
    seoDescription: "Discover our timber wheelchair access and steps installation in West Central Scotland. Professional decking installation transforming outdoor spaces with accessibility in mind.",
  ...
  },
  {
    ...
    seoTitle: "Composite Decking with Glass & Handrails Kings Park Glasgow | Glasgow Fencing Contractors",
  ...
  },
  {
    ...
    imageAlt: "Timber decking installation in West Central Scotland",
    seoTitle: "Timber Decking Installation West Central Scotland | Glasgow Fencing Contractors",
    seoDescription: "Explore our timber decking project completed in West Central Scotland. High-quality decking installation demonstrating natural wood beauty and professional workmanship.",
